...
```
git clone https://github.com/yianding/hayekpos && cd hayekpos
./clean.sh
docker compose up -d
```
...
$ docker compose up -d
[+] Running 7/7
 ⠿ Network hayekpos_default                          Created
 ⠿ Container hayekpos-geth-genesis-1                 Started
 ⠿ Container hayekpos-create-beacon-chain-genesis-1  Started
 ⠿ Container hayekpos-geth-account-1                 Started
 ⠿ Container hayekpos-geth-1                         Started
 ⠿ Container hayekpos-beacon-chain-1                 Started
 ⠿ Container hayekpos-validator-1                    Started
```
...
```
# How to use this hayekpos
- add network to your metmask wallet with fellow
